...
Parameters:
   -None,
   - This stored procedure does not accept any parameters or return the values
...
BEGIN
    BEGIN TRY
        ...
        SET @end_time = GETDATE();
        PRINT 'Load Buration:' + CAST(DATEDIFF(second,@start_time,@end_time) AS VARCHAR)+ 'Seconds';
    ...
    PRINT 'Load Duration:' + CAST(DATEDIFF(second,@silver_start_time,@silver_end_time) AS VARCHAR) + 'Seconds';
END
